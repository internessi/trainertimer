...
class TraierTimerCard extends StatelessWidget {
  ...
  final String image;
  final int index, style, gerFlag, engFlag, ruFlag, comingSoon;

  TraierTimerCard(this.title1, this.title2, this.footer, this.image, this.index,
      this.style, this.gerFlag, this.engFlag, this.ruFlag, this.comingSoon);
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Padding(
                              padding:
                                  EdgeInsets.only(right: 10, top: 7, left: 10),
                              child: style == 0
                                  ? Row(
                                      children: [
                                        Spacer(),
